...
public class addMember extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String membership=(String)jComboBox1.getSelectedItem();
  membership=membership.toString().trim().toLowerCase();
      if(GYMSystem.e.addMember(membership, session, gender, mobile, nationalId, membership))
      {
        JOptionPane.showMessageDialog(null,"Member added successfully"); 
      }
      else{
       JOptionPane.showMessageDialog(null,"Member"+name+" already existrs");
       }    
